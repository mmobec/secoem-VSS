...
model.SsI = pyo.Set(
    initialize=lambda m: [
        ...
        for l in m.S
        for j in m.S
        if (pyo.value(m.lI[3,t, l]) <= pyo.value(m.lI[3,t, j]) and j != l)
    ]
)
# =============================================================================
