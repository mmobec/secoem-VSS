...
\begin{tabular}{c c c c}
	...
	12& $fd_8, afd^{\pm}_8, c_{8, \omega}, d_{8, \omega}, id_{8, \omega}, \soc_{8, \omega}$ & $W_8, PV_8, \lambda^{IB+}_{8, \omega} \in \R$ & $p^{IB+}_{8, \omega}, p^{IB-}_{8, \omega}$ \\
    ...&...&...&...\\
	41& $fd_{37}, afd^{\pm}_{37}, c_{37, \omega}, d_{37, \omega}, id_{37, \omega}, \soc_{37, \omega}$ & $W_{37}, PV_{37}, \lambda^{IB+}_{37, \omega} \in \R$ & $e^{IB+}_{37, \omega}, e^{IB-}_{37, \omega}$\\
	42& $fd_{38}, afd^{\pm}_{38}, c_{38, \omega}, d_{38, \omega}, id_{38, \omega}, \soc_{38, \omega}$ & $W_{38}, PV_{38}, \lambda^{IB\pm}_{38, \omega} \in \R$ & $e^{IB+}_{38, \omega}, e^{IB-}_{38, \omega}$\\
    43& $fd_{39}, afd^{\pm}_{39}, c_{39, \omega}, d_{39, \omega}, id_{39, \omega}, \soc_{39, \omega}$ & $W_{39}, PV_{39}, \lambda^{IB\pm}_{39, \omega} \in \R$ & $e^{IB+}_{39, \omega}, e^{IB-}_{39, \omega}$\\
	44& $fd_{40}, afd^{\pm}_{40}, c_{40, \omega}, d_{40, \omega}, id_{40, \omega}, \soc_{40, \omega}$ & $W_{40}, PV_{40}, \lambda^{IB\pm}_{40, \omega} \in \R$ & $e^{IB+}_{40, \omega}, e^{IB-}_{40, \omega}$\\
	45& $e^{IM}_{3, t, \omega}$ & $\lambda^I_3 \in \R^{T_3}$&\\
	46& $fd_{41}, afd^{\pm}_{41}, c_{41, \omega}, d_{41, \omega}, id_{41, \omega}, \soc_{41, \omega}$ & $W_{41}, PV_{41}, \lambda^{IB\pm}_{41, \omega} \in \R$ & $p^{IB+}_{41, \omega}, p^{IB-}_{41, \omega}$ \\
	47& $fd_{42}, afd^{\pm}_{42}, c_{42, \omega}, d_{42, \omega}, id_{42, \omega}, \soc_{42, \omega}$ & $W_{42}, PV_{42}, \lambda^{IB\pm}_{42, \omega} \in \R$ & $e^{IB+}_{42, \omega}, e^{IB-}_{42, \omega}$\\
	48& $fd_{43}, afd^{\pm}_{43}, c_{43, \omega}, d_{43, \omega}, id_{43, \omega}, \soc_{43, \omega}$ & $W_{43}, PV_{43}, \lambda^{IB\pm}_{43, \omega} \in \R$ & $e^{IB+}_{43, \omega}, e^{IB-}_{43, \omega}$\\
	49& $fd_{44}, afd^{\pm}_{44}, c_{44, \omega}, d_{44, \omega}, id_{44, \omega}, \soc_{44, \omega}$ & $W_{44}, PV_{44}, \lambda^{IB\pm}_{44, \omega} \in \R$ & $e^{IB+}_{44, \omega}, e^{IB-}_{44, \omega}$\\
    ...&...&...&...\\
	98& $fd_{93}, afd^{\pm}_{93}, c_{93, \omega}, d_{93, \omega}, id_{93, \omega}, \soc_{93, \omega}$ & $W_{93}, PV_{93}, \lambda^{IB\pm}_{93, \omega} \in \R$ & $e^{IB+}_{93, \omega}, e^{IB-}_{93, \omega}$\\
	99& $fd_{94}, afd^{\pm}_{94}, c_{94, \omega}, d_{94, \omega}, id_{94, \omega}, \soc_{94, \omega}$ & $W_{94}, PV_{94}, \lambda^{IB\pm}_{94, \omega} \in \R$ &  $e^{IB+}_{94, \omega}, e^{IB-}_{94, \omega}$\\
	100& $fd_{95}, afd^{\pm}_{95}, c_{95, \omega}, d_{95, \omega}, id_{95, \omega}, \soc_{95, \omega}$ & $W_{95}, PV_{95}, \lambda^{IB\pm}_{95, \omega} \in \R$ & $e^{IB+}_{95, \omega}, e^{IB-}_{95, \omega}$\\
	101& $fd_{96}, afd^{\pm}_{96}, c_{96, \omega}, d_{96, \omega}, id_{96, \omega}, \soc_{96, \omega}$  & $W_{96}, PV_{96}, \lambda^{IB\pm}_{96, \omega} \in \R$ & $e^{IB+}_{96, \omega}, e^{IB-}_{96, \omega}$\\
